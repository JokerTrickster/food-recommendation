    ...
    "paths": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.ReqSaveFCMToken"
                        }
                    }
                ],
                "responses": {
        ...
        "/v0.1/foods": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "이름, 시간, 상황, 맛, 테마, 종류",
                        "name": "type",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.ReqSaveFood"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.ReqMessageUser"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.ReqV1RecommendFood"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/response.ResV1RecommendFood"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "request.ReqSaveFood": {
            ...
            "properties": {
                "foods": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/request.SaveFood"
                    }
                }
            }
        },
