...
INSERT INTO scenarios (name, description,image) VALUES ('연인', '연인','scenarios/couple.png'), ('혼밥', '혼밥','scenarios/eating alone.png'), ('가족', '가족','scenarios/family.png'), ('다이어트', '다이어트','scenarios/diet.png'), ('회식', '회식','scenarios/company dinner.png'), ('친구', '친구','scenarios/friend.png');
