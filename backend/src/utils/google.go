...
func InitGoogleOauth() error {
	...
	authMeta.GoogleIosID = "706198886562-qusk0tubffugksvahnqf4vjrn4s55dgq.apps.googleusercontent.com"
	authMeta.GoogleAndID = []string{"706198886562-qusk0tubffugksvahnqf4vjrn4s55dgq.apps.googleusercontent.com"}
